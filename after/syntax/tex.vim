...
if has('conceal')
  ...
  syn match texBoldMathText '\\bA\>' contained conceal cchar=A
  syn match texBoldMathText '\\bB\>' contained conceal cchar=B
  syn match texBoldMathText '\\bC\>' contained conceal cchar=C
  syn match texBoldMathText '\\bD\>' contained conceal cchar=D
  syn match texBoldMathText '\\bE\>' contained conceal cchar=E
  syn match texBoldMathText '\\bF\>' contained conceal cchar=F
  syn match texBoldMathText '\\bG\>' contained conceal cchar=G
  syn match texBoldMathText '\\bH\>' contained conceal cchar=H
  syn match texBoldMathText '\\bI\>' contained conceal cchar=I
  syn match texBoldMathText '\\bJ\>' contained conceal cchar=J
  syn match texBoldMathText '\\bK\>' contained conceal cchar=K
  syn match texBoldMathText '\\bL\>' contained conceal cchar=L
  syn match texBoldMathText '\\bM\>' contained conceal cchar=M
  syn match texBoldMathText '\\bN\>' contained conceal cchar=N
  syn match texBoldMathText '\\bO\>' contained conceal cchar=O
  syn match texBoldMathText '\\bP\>' contained conceal cchar=P
  syn match texBoldMathText '\\bQ\>' contained conceal cchar=Q
  syn match texBoldMathText '\\bR\>' contained conceal cchar=R
  syn match texBoldMathText '\\bS\>' contained conceal cchar=S
  syn match texBoldMathText '\\bT\>' contained conceal cchar=T
  syn match texBoldMathText '\\bU\>' contained conceal cchar=U
  syn match texBoldMathText '\\bV\>' contained conceal cchar=V
  syn match texBoldMathText '\\bW\>' contained conceal cchar=W
  syn match texBoldMathText '\\bX\>' contained conceal cchar=X
  syn match texBoldMathText '\\bY\>' contained conceal cchar=Y
  syn match texBoldMathText '\\bZ\>' contained conceal cchar=Z
